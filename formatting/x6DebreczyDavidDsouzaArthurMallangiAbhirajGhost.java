...
public class x6DebreczyDavidDsouzaArthurMallangiAbhirajGhost extends x6DebreczyDavidDsouzaArthurMallangiAbhirajSquare implements x6DebreczyDavidDsouzaArthurMallangiAbhirajAnimatable {
   private int x;
   private int y;
   ...
   public x6DebreczyDavidDsouzaArthurMallangiAbhirajGhost(int x, int y, Color c) {
      ...
      this.x = x;
      this.y = y;
      this.matrix = x6DebreczyDavidDsouzaArthurMallangiAbhirajMap.getLevel();
   }
   ...
   public void ghostMove() {
      ...
      isEat = x6DebreczyDavidDsouzaArthurMallangiAbhirajMap.getEatable();
